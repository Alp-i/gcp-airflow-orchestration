...
BODY = {
    "launch_parameter": {
        ...
        "parameters": {
            ...
            "labels": "{\"goog-dataflow-provided-template-name\":\"mysql_to_bigquery\",\"goog-dataflow-provided-template-type\":\"flex\",\"goog-dataflow-provided-template-version\":\"2025-08-26-00_rc00\"}"
        },
        "environment": {
            "numWorkers": 2,
